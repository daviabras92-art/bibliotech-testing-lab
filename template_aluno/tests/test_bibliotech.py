...
def test_rf01_limite_tres_emprestimos():
    """
    Valor-limite do RF01.

    O requisito determina que o usuário deve possuir
    MENOS de 3 empréstimos ativos. Portanto, com exatamente
    3 empréstimos, o empréstimo deve ser recusado.
    """
    resultado = pode_emprestar(
        usuario_ativo=True,
        possui_pendencia=False,
